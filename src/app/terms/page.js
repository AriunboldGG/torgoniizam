              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="mb-8">
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>
                      Худалдан авахгүй бол дэнчингийн 1%-ийг системийн шимтшэл
                      болгон хасагдана
                    </li>
                  </ul>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>
                      Ялагч болсон тохиолдолд барааны үнийг 24 цагийн дотор
                      төлөх ёстой
                    </li>
                    <li>
                      Төлбөр хийгдээгүй тохиолдолд бараа дараагийн өндөр үнэтэй
                      санал болгон дахин дуудлага худалдаанд гарна
                    </li>
                ...
                <div className="mb-8">
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>
                      Хэрэв зөвшөөрөлд хүрэхгүй бол Монголын арбитрын шүүхэд
                      ханд
                    </li>
